...
=======
    ...
    <div class="container">
           ...
           <div class="user__info">
                <div class="user__avatar">
                    <?php if (!empty($user['avatar'])): ?> 
                        <img class="img" src="<?= htmlspecialchars($user['avatar']) ?>" alt="Фото"> 
                    <?php endif; ?>
                </div>
                ...
                <a class="user__edit_a" href="/profedit">Редагувати профіль</a>
            </div>
                        ...
                        <?php foreach ($twitts as $twitt): ?>
                            <li>
                                <div class="twitt">
                                    ...
                                    <!-- Перевірка наявності зображення і його відображення -->
                                    <?php if (!empty($twitt['image'])): ?>
                                        <img src="<?= htmlspecialchars($twitt['image']) ?>" alt="Зображення для твіту" class="twitt-image">
                                    <?php endif; ?>

                                    <!-- Виведення тексту твіту -->
                                    <p class="twitt__content" id="tweet-content-<?php echo $twitt['id']; ?>">
                                        <?php echo htmlspecialchars($twitt['twitt']); ?>
                                    </p>
        ...
        <script src="public/js/editTwitt.js" ></script>
>>>>>>> 4986444 (twitty 1.5)
